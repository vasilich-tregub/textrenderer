...
int main()
{
    ...
    colorstruct fillColor{ 0.757, 0.329, 0.757, 1. }; // deep fuchsia
    colorstruct outlineColor{ 0.290, 0.392, 0.424, 1. }; // deep space sparkle

    double linePos = 0;

    RenderText(u8text, fdesc, fillColor, outlineColor, 2.5,
    ...
    auto status = cairo_surface_write_to_png(surface, "wide_column.png");
